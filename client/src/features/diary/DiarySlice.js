...
import {
    createOrUpdateEntryAPI, deleteEntryAPI,
    fetchCalendarAPI, fetchCurrentMonthEntriesAPI,
    fetchUserEntryAPI
} from "./DiaryAPI";
...
export const { updateCurrentEntry, updateCurrentYear, updateCurrentMonth, updateCurrentEntryTitle,
    ...
    resetUIElements } = diarySlice.actions
