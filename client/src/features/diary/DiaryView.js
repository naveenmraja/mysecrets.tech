            ...
            <Grid container
                ...
                <Grid container
                    ...
                    <Grid item xs={11} md={6}>
                        <Snackbar open={this.props.ui.showSnackbar && this.props.ui.errorMessage}
                                  autoHideDuration={5000} onClose={this.closeSnackbar}>
                ...
                <Grid container
                    ...
                    <Grid item xs={11} md={6} sx={{height: "100%"}}>
                        ...
                        <StyledPaper elevation={24}
                                     sx={{height: "100%", width: "100%", bgcolor: "#fff8c0", overflow: "scroll"}}>
