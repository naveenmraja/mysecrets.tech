...
import {
    deleteEntry, removeDateFromCalendarEntries, removeFromCurrentMonthEntries,
    updateCurrentEntry
            ...
            <Grid item xs={12} md={4} className={"entryCard"}>
                <Card  sx={{height: "90%", bgcolor: "#fff8c0", width: "100%"}} raised>
                    ...
                    <CardActions sx={{float: "right", height: "20%"}}>
                        ...
                        <Button color={"secondary"} startIcon={<DeleteOutlined />} onClick={() => this.setState({ showConfirmDeleteEntry : true })}>
                            Delete
                        </Button>
